    ...
    render(){
        ...
        return(
            <View keyboardShouldPersistTaps="always">
                ...
                <TouchableOpacity
                  style={{width: SCREEN_WIDTH/4.5,height:SCREEN_HEIGHT/8.1,backgroundColor:'#B87548',borderColor:'#B87548',borderWidth:1,marginBottom:50,borderRadius:100,justifyContent:'center'}}
                  onPress={() => {
