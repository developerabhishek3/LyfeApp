...
export default class index extends Component {
  ...
  render() {
    ...
    // console.log("getting inside the render method----------",category)
    return (
              ...
              <Fragment>   
                  {
                    ...
                    {categoryData.map((singleData, index) => {
                      ...
                      // console.log("Checking here for testing>>>>>>>>>>",Object.keys(singleData))
                      return (
                        <Fragment>
                                ...
                                return (
                                  <View>
                                    <ScrollView horizontal={true}>
                                      {/* <Text>{singleCategory.categoryName}</Text> */}
