...
import { Logout,UserProfile,MyNotificationCount, InstagramInfo } from '../../../Api/afterAuth';
    ...
    LogoutFunction = async () => {
      ...
      userProfileFunction = async () => {
        ...
        if(UserProfileResponse.result === true) {
            ...
            var InstagramName = UserProfileResponse.response.my_profile.insta_name

            AsyncStorage.setItem("InstagramName",JSON.stringify(InstagramName))
