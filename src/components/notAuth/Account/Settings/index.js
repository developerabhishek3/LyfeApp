...
import {MySetting,UpdateSettings} from '../../../../Api/afterAuth';
            ...
            <View
              style={{
                ...
                margin: 10,
                        ...
                        <Text style={{fontFamily:'Montserrat-Regular',fontWeight:'600',fontSize:16,paddingStart:20}}>Email Notification</Text>
                        <Switch
            ...
            <View
              style={{
                ...
                margin: 10,
                        ...
                        <Text style={{fontFamily:'Montserrat-Regular',fontWeight:'600',fontSize:16,paddingStart:20}}>Push Notification</Text>
                        <Switch
