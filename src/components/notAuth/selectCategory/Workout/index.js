...
import {advertisement_by_category} from '../../../../Api/afterAuth';
export default class index extends Component {
  ...
  fetchAdvertisementByCategorytDetails = async () => {
    ...
    if (AdvertisementByCategoryResponse.result == true) {
      //   console.log("getting response here-------------",AdvertisementByCategoryResponse.response)
        ...
        <View style={styles.contentView}>
          {
           ...
           ?
            ...
            {/* <View style={styles.ImgView}>
                    <TouchableOpacity onPress={()=>{this.props.navigation.navigate("workoutdetails")}}>
                            <ImageBackground resizeMode="stretch" imageStyle={styles.bgImageMainStyle} source={workout2} style={styles.bgImgStyle} >
                            <View style={styles.imgBottomView} >
                                <Text style={styles.mainText}>France Gym </Text>
                                <View style={styles.subText}>
                                    <Image source={location} style={styles.subImgStyle} />
                                    <Text>63, Avenue Ledru, Paris, 75002</Text>
                                </View>
                            </View>                            
                            </ImageBackground>
                        </TouchableOpacity>
                    ...
                    <View style={styles.ImgView}>
                        <TouchableOpacity onPress={()=>{this.props.navigation.navigate("workoutdetails")}}>
                        <ImageBackground resizeMode="stretch" imageStyle={styles.bgImageMainStyle} source={workout} style={styles.bgImgStyle} >
                         <View style={styles.imgBottomView} >
                            <Text style={styles.mainText}>France Gym </Text>
                            <View style={styles.subText}>
                                <Image source={location} style={styles.subImgStyle} />
