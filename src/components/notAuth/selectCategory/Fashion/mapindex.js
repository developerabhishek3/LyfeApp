  ...
  render() {
    ...
    return (                                  
            <View style={styles.container}>    
                      ...
                      <View style={{height:SCREEN_HEIGHT/9,justifyContent:'space-between',backgroundColor:'#B87548',width:'100%',borderWidth:0,flexDirection:'row',    borderBottomLeftRadius: 50,
