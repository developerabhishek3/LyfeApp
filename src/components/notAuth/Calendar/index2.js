...
import {GetMyPendingReservation, GetPastAgenda,MyNotificationCount} from '../../../Api/afterAuth';
                    ...
                    <TouchableOpacity
                      ...
                      <View style={{borderWidth:0,  justifyContent:'center',
                        ...
                        <View style={{flexDirection: 'column', margin: 3,justifyContent:'center',borderWidth:0,marginTop:3}}>
                          <Text
                            style={{fontSize: 13, fontWeight: '700', margin: 1,fontFamily:'Montserrat-Regular'}}>
                          ...
                          <View style={{flexDirection:'row',borderWidth:0,marginEnd:10,width:SCREEN_WIDTH*0.6}}>
                            ...
                            <Text  numberOfLines={1} style={{fontSize: 10, fontWeight: '600', margin: 3,fontFamily:'Montserrat-Regular'}}>{singlePendingData.location}</Text>
                          </View>
                          <View>
                          {
                            ...
                            <Text
                            style={{fontSize: 10, fontWeight: '600', margin: 1,marginStart:7,fontFamily:'Montserrat-Regular'}}>
                          ...
                          <View style={{flexDirection:'row',margin:1}}>
                            <FastImage source={dateTimeIcon} style={{width:14,height:14,margin:1}} />
                          <Text
                          style={{fontSize: 10, fontWeight: '600', margin: 1,fontFamily:'Montserrat-Regular'}}>
                          ...
                          </View>  
                          {
                            ...
                            <Text
                             style={{fontSize: 11, fontWeight: '700',color:'#B87548', margin: 1,fontFamily:'Montserrat-Regular'}}>
