...
openMap() {
  ...
  Platform.select({
  ios: () => {
  Linking.openURL('http://maps.apple.com/maps?saddr=' + s_lat_val + ',' + s_lng_val + '&daddr=' + d_lat_val + ',' + d_lng_val);
  },
  android: () => {
                        ...
                        <Fragment>
                          {advertisementDetailsad_product_sizeData.map(
                           ...
                           <View style={styles.rewardTxtView}>
                             ...
                             <Text style={{    fontFamily:'Montserrat-Regular',fontWeight:'700',fontSize:12}}>
