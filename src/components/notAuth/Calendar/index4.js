      ...
      <StatusBar
        ...
        <View style={{borderColor:'red',borderWidth:0,width:'100%',marginStart:20}}>
          ...
          <TouchableOpacity key={'Next'}
              ...
              <TouchableOpacity key={'Previous'} style={{borderColor:'red',height:40,justifyContent:'center', borderWidth:0,borderRadius:50,backgroundColor:'#B87548',margin:4,marginStart:5,marginEnd:5}}>
