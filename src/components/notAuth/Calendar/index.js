...
import {  GetFutureAgenda,MyNotificationCount} from '../../../Api/afterAuth';
        ...
        <View
          style={{
            ...
            justifyContent:'space-around'
              ...
              <TouchableOpacity   style={{borderColor:'red',height:40,justifyContent:'center',width:'45%', borderWidth:0,borderRadius:50,backgroundColor:'#B87548',margin:4,marginStart:5,marginEnd:5}}>
                     ...
                     <TouchableOpacity
                      ...
                      this.props.navigation.navigate('addetail', {
                        ...
                        <View style={{flexDirection:'row',margin:2,}}>
                          ...
                          <Text style={{fontSize:14,fontWeight:'700',margin:1,fontFamily:'Montserrat-Regular'}}>{singleApproveData.merchant_company_name}</Text>
                          <View>
                          <View style={{flexDirection:'row',borderWidth:0,marginEnd:10,width:SCREEN_WIDTH*0.6}}>
                            ...
                            <Text  numberOfLines={1} style={{fontSize: 10, fontWeight: '600', margin: 3,fontFamily:'Montserrat-Regular'}}>{singleApproveData.location}</Text>
                          </View>
                         {
                          ...
                          <Text
                          style={{fontSize: 10, fontWeight: '600', paddingStart:4,margin: 1,fontFamily:'Montserrat-Regular'}}>
                        ...
                        <Text
                        style={{fontSize: 10, fontWeight: '600', margin: 1,paddingStart:4,fontFamily:'Montserrat-Regular'}}>
                        ...
                        </View>  
                        {
                          ...
                          <Text
                          style={{fontSize: 11, fontWeight: '700',paddingStart:4,color:'#B87548', margin: 1,fontFamily:'Montserrat-Regular'}}>
                          ...
                          <View style={{flexDirection:'row',margin:1}}>
                             <FastImage  source={statusIcon} style={{width:14,height:14,margin:1}}/>
                            <Text
                            style={{fontSize: 11, fontWeight: '700',paddingStart:4, margin: 1,color:'#B87548',fontFamily:'Montserrat-Regular'}}>
                            {singleApproveData.reserve_status}
                            </Text>
                          {
                            singleApproveData.reschedule_status === `Waiting` ?
                            <Text
                            style={{fontSize: 11, fontWeight: '700', margin: 1,paddingStart:4,color:'red',fontFamily:'Montserrat-Regular'}}>
                            ({singleApproveData.reschedule_status})
                            </Text>
                            :
                            <Text
                            style={{fontSize: 11, fontWeight: '700', margin: 1,paddingStart:4,color:'#B87548',fontFamily:'Montserrat-Regular'}}>
                            ({singleApproveData.reschedule_status})
                            </Text>
                          }
                            {/* <Text
